...
function Contact() {
    ...
    const sendemail =(e)=>{
        ...
        emailjs.sendForm('service_caei42n','template_6d9qm6c',formRef.current,'oTiBA2S2sdqz8A1as')
        .then((result)=>{
            setError(false)
        ...
        <motion.div ref={ref} className='contact' variants={variants} initial="initial" whileInView="animate">
            <motion.div className="txtContainer" variants={variants}>
                ...
                <motion.div className="item" variants={variants}>
                    <h2>Mail</h2>
                    <span>ahmedshavez55@gmail.com</span>
                </motion.div>
                <motion.div className="item" variants={variants}>
                    <h2>Address</h2>
                ...
                <motion.div className="item" variants={variants}>
                    <h2>Phone</h2>
                    <span>+91 8368131094</span>
                </motion.div>
            </motion.div>

            <div className="formContainer">
                <motion.div className="phoneSvg" initial={{ opacity: 1 }} whileInView={{ opacity: 0 }} transition={{ duration: 3, delay: 2 }}>
                ...
                ref={formRef}
                    ...
                    <input type='email' placeholder='Email' required name='your_email'/>
